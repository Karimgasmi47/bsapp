...
class IssueController extends AbstractController
{
     ...
     */
    public function index(IssueRepository $issueRepository, DataTableFactory $dataTableFactory): Response
    {
        return $this->render('issue/index.html.twig', [
            'issues' => $issueRepository->findAll(),
            'list_datas' => [
                'issues' => [
                    'headers' => ['#', 'TYPE', 'TITRE', 'STATUT', 'PRIORITÉ', 'DERNIÈRE ACTIVITÉ' , ''],
                    'datas' => $issueRepository->findAll(),
                    'actions' => []
                ],
            ],
        ]);
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $issue->setStatus($this->getDoctrine()->getRepository(IssueStatus::class)->findOneBy(
                ['constant_code' => IssueStatus::OPEN]
            ));
    ...
    public function show(Issue $issue): Response
    {
        return $this->render('issue/show.html.twig', [
            'issue' => $issue,
            'comments' => $issue->getIssueComments()
        ]);
    }
